...
class Order {
    ...
    public:
        ...
        virtual ~Order() = default; // default destructor
        int getId() const;
        ...
        int getDistance() const; // added by us
        string ordStatusToString(OrderStatus ordstat) const; // added by us - OrderStatus to string
        Order* clone() const;
